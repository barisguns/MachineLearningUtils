"""
The aim of this script is to show the use of custom scorer confusion_matrix_scorer from dsutils.metrics.
...
from dsutils.metrics import confusion_matrix_scorer
